...
swift rlhf \
    --rlhf_type grpo \
    --model /mnt/tenant-home_speed/ywr/LLamafactory/LLaMA-Factory-0.9.3/saves/qwen2.5_vl_VRT_random_1k_0724/full/sft \
    --external_plugins /mnt/tenant-home_speed/ywr/Token_mask/code/plugin.py \
    --reward_funcs external_r1v_acc \
    --train_type full \
    --torch_dtype bfloat16 \
    --dataset /mnt/tenant-home_speed/ywr/Token_mask/Datasets_0724/VRT_GRPO/random_VRT_GRPO_1_6k.jsonl \
    --max_length 2048 \
