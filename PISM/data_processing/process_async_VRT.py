...
if __name__ == '__main__':
    # 配置参数
    config = {
        "dataset_path": "/mnt/tenant-home_speed/qjy/rest_dataset/rest_VRT.jsonl",
        "url_pool": ["http://localhost:7803/v1/chat/completions"],
        "num_iterations": 10,  # 迭代次数（原num_generations）
        "seed": 42,
        "output_dir": "/mnt/tenant-home_speed/ywr/Token_mask/results_VRT_0715",
