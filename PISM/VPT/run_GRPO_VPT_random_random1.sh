...
swift rlhf \
    --rlhf_type grpo \
    --model /mnt/tenant-home_speed/ywr/LLamafactory/LLaMA-Factory-0.9.3/saves/qwen2.5_vl_VPT_random_1_4k_0724/full/sft \
    --external_plugins /mnt/tenant-home_speed/ywr/Token_mask/code/plugin.py \
    --reward_funcs visual_perception_accuracy \
    --train_type full \
    --torch_dtype bfloat16 \
    --dataset /mnt/tenant-home_speed/ywr/Token_mask/Datasets_0724/VPT_GRPO/random_VPT_GRPO_4_9k.jsonl \
    --max_length 2048 \
