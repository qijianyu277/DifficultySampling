...
swift rlhf \
    --rlhf_type grpo \
    --model /mnt/tenant-home_speed/qjy/LLaMA-Factory/saves/SFT_VPT_random6k/full/sft/checkpoint-240/ \
    ...
    --dataset /mnt/tenant-home_speed/qjy/attention_VPT_eval/swift_output_grpo/random_VPT_0.4-1.6.jsonl \
    --max_length 2048 \
    ...
    --save_total_limit 30 \
    --logging_steps 1 \
    --output_dir output/randon6k_random1k \
    --warmup_ratio 0.01 \
