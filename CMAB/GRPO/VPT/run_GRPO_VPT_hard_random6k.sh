...
swift rlhf \
    --rlhf_type grpo \
    --model /mnt/tenant-home_speed/qjy/LLaMA-Factory/saves/SFT_VPT_hard/full/sft/checkpoint-40/ \
    ...
    --dataset /mnt/tenant-home_speed/qjy/attention_VPT_eval/swift_output_grpo/random_VPT_0.1-0.4_and_1.6-1.9.jsonl \
    --max_length 2048 \
    ...
    --save_total_limit 30 \
    --logging_steps 1 \
    --output_dir output/sft_grpo/hard_random6k \
    --warmup_ratio 0.01 \
