MASTER_PORT=29501 WANDB_MODE=offline MAX_PIXELS=1254400 CUDA_VISIBLE_DEVICES=4,5,6,7 \
WANDB_API_KEY= \
NPROC_PER_NODE=4 \
swift rlhf \
    --rlhf_type grpo \
    ...
    --dataset path/to/your/VRT_0.2-1.8.jsonl  \
    --max_length 2048 \
    ...
    --save_total_limit 20 \
    --logging_steps 1 \
    --output_dir outputpath/to/your/GRPO_VPT \
    --warmup_ratio 0.01 \
