...
swift rlhf \
    --rlhf_type grpo \
    --model /mnt/shared/wireless_robot/zd/qjy/SFT_GRPO/VRT/saves/SFT_VRT_mid/checkpoint-145 \
    ...
    --dataset /mnt/shared/wireless_robot/zd/qjy/attention_VRT_eval/swift_output_grpo/random_VRT_0.4-1.6.jsonl  \
    --max_length 2048 \
    ...
    --save_total_limit 30 \
    --logging_steps 1 \
    --output_dir output/mid_random2.1k \
    --warmup_ratio 0.01 \
