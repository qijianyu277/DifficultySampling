WANDB_MODE=offline MAX_PIXELS=3120320 CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 \
...
swift rlhf \
    ...
    --dataset /mnt/shared/wireless_robot/zd/qjy/attention_VRT_eval/swift_output_grpo/random_VRT_0.1-0.4_and_1.6-1.9.jsonl  \
    --max_length 2048 \
    ...
    --save_total_limit 30 \
    --logging_steps 1 \
    --output_dir output/hard_random3.6k \
    --warmup_ratio 0.01 \
