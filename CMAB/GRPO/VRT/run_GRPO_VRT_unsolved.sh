MAX_PIXELS=1254400 CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 \
...
swift rlhf \
    ...
    --dataset /mnt/tenant-home_speed/qjy/attention_eval/VRT/swift_output_grpo/unsolved.jsonl \
    --max_length 2048 \
    ...
    --save_total_limit 40 \
    --logging_steps 1 \
    --output_dir output/GRPO_VRT/unsolved \
    --warmup_ratio 0.01 \
